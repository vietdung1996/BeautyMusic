...
public class GetDataSdCard   {
    ...
    public List<Songs> getData() {
        final List<Songs> songsList= new ArrayList<>();
        Thread thread = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                if (screen == 111) {
                    ...
                    int idAlbums = activity.getIntent().getIntExtra(Contanst.rq_screen_idalbums, -1);
                    ContentResolver cr = activity.getContentResolver();
                    Uri musicUri = MediaStore.Audio.Media.EXTERNAL_CONTENT_URI;
                    Cursor musicCursor = cr.query(musicUri, null, null, null, null);
                    ...
                    int idArtist = activity.getIntent().getIntExtra(Contanst.rq_screen_idartist, -1);
                    ContentResolver cr = activity.getContentResolver();
                    Uri musicUri = MediaStore.Audio.Media.EXTERNAL_CONTENT_URI;
                    Cursor musicCursor = cr.query(musicUri, null, null, null, null);
